...
本机正式入口为 `http://127.0.0.1:8000/`，环境为 `production`，数据目录为 `%LOCALAPPDATA%\HonghaoAI\production`（Codex 宿主可能映射到自身 LocalCache）。2026-09-10 已重新核验健康、就绪及页面构建一致性；当天功能仍有未提交改动，不能将远端 main 当作当前正式服务的完整代码快照，详见 [提交准备](./docs/提交准备-2026-09-10.md)。
