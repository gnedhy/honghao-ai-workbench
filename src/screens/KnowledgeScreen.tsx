...
type KnowledgeScreenProps = ScreenChromeProps & {
  scopeTab: keyof typeof scopeByTab;
  onScopeTabChange: (scope: keyof typeof scopeByTab) => void;
...
export function KnowledgeScreen({ contextOpen, onOpenNavigation, onToggleContext, scopeTab, onScopeTabChange, selectedTitle, onSelectedTitleChange }: KnowledgeScreenProps) {
