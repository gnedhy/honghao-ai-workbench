...
def configure(path, actor, apply=False):
    ...
    if apply:
        ...
        for username, name, level, user in plan:
            ...
            AuthorizationStore(path).audit('research.account.configured', actor_user_id=actor,
...
if __name__ == '__main__':
    ...
    print(json.dumps(configure(args.database, args.actor, args.apply), ensure_ascii=False, indent=2))
